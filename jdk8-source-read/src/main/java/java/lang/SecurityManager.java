 ...
 * permission categories are <code>FilePermission</code>,
 * <code>SocketPermission</code>,
 * <code>NetPermission</code>,
 ...
 * for a <code>FilePermission</code> object, the permission name is
 * the path name of a file (or directory).
 *
 * <p>Some of the permission classes have an "actions" list that tells
 * the actions that are permitted for the object.  For example,
 * for a <code>FilePermission</code> object, the actions list
...
class SecurityManager {
     ...
     * <p>
     * This method calls <code>checkPermission</code> with the
     * <code>SocketPermission(maddr.getHostAddress(),
