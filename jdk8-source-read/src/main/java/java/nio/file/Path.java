 ...
 * with the {@link java.io.File File} class. Paths created by other
 * providers are unlikely to be interoperable with the abstract path names
 * represented by {@code File}. The {@link java.io.File#toPath toPath}
 * method may be used to obtain a {@code Path} from the abstract path name
 * represented by a {@code File} object. The resulting {@code Path} can
 * be used to operate on the same file as the {@code File} object. In
    ...
    extends Comparable<Path>, Iterable<Path>, Watchable
{
     ...
     * the {@code URI} may be used to construct a {@link java.io.File File}.
