 ...
 *
 * <p>Only objects that support the Serializable interface can be
 ...
 * implement the Serializable interface.  Subclasses of Objects that
    ...
    extends OutputStream implements ObjectOutput, ObjectStreamConstants
{
     ...
     * other alternative.
     *
     * @param   version use ProtocolVersion from ObjectStreamConstants.
