...
public interface ResultSet extends Wrapper, AutoCloseable {
     ...
     * @return a <code>Reader</code> object that contains the column
     ...
     *
     * @param columnLabel the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column
     * @param reader the <code>Reader</code> object containing
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as a <code>URL</code>
     * object in the Java programming language.
     *
     * @param columnIndex the index of the column 1 is the first, 2 is the second,...
     * @return the column value as a <code>URL</code> object;
     * if the value is SQL <code>NULL</code>,
     * the value returned is <code>null</code> in the Java programming language
     * @exception SQLException if the columnIndex is not valid;
   ...
   * if the driver does not support national
     ...
     * <code>Reader</code> object. The JDBC driver will
