...
public interface PreparedStatement extends Statement {
     ...
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
     * @param x a <code>InputStream</code> object that contains the
    ...
    */
     ...
     *  <code>Struct</code>, <code>URL</code>, <code>RowId</code>, <code>SQLXML</code>
  ...
  void setNull (int parameterIndex, int sqlType, String typeName)
    ...
    /**
     * Sets the designated parameter to the given <code>URL</code> value.
     * The driver converts this to an SQL <code>DATALINK</code> value
     * when it sends it to the database.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
     * @param x the <code>URL</code> object to be set
     * @exception SQLException if parameterIndex does not correspond to a parameter
     * marker in the SQL statement; if a database access error occurs or
     * this method is called on a closed <code>PreparedStatement</code>
     * @throws SQLFeatureNotSupportedException  if the JDBC driver does not support this method
