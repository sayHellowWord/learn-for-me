...
public interface RowSet extends ResultSet {
  ...
  /**
   * Sets the designated parameter in this <code>RowSet</code> object's command
   * to the given <code>InputStream</code> value.
   * It may be more practical to send a very large ASCII value via a
   * <code>InputStream</code> rather than as a <code>LONGVARCHAR</code>
   ...
   * <code>InputStream</code> rather than as a <code>LONGVARBINARY</code>
   * parameter. The driver will read the data from the stream
   * as needed until it reaches end-of-file.
   *
   * <P><B>Note:</B> This stream object can either be a standard
  ...
  /**
   * Sets the designated parameter in this <code>RowSet</code> object's command
   * to the given <code>Reader</code> value.
   * It may be more practical to send a very large UNICODE value via a
   * <code>Reader</code> rather than as a <code>LONGVARCHAR</code>
   * parameter. The driver will read the data from the stream
   * as needed until it reaches end-of-file.
   *
   * <P><B>Note:</B> This stream object can either be a standard
