...
public interface WebRowSet extends CachedRowSet {
    ...
    * {@code Reader} object.
    *
    * @param reader the {@code Reader} stream from which this
    ...
    */
     ...
     * object.
     *
     * @param iStream the {@code InputStream} from which this
     *        {@code WebRowSet} object will be populated
    ...
    * @param writer the {@code Writer} object to write to.
    ...
    * to the given {@code Writer} object in XML format.
    *
    * @param writer the {@code Writer} stream to write to
    * @throws SQLException if an error occurs writing out the rowset
    *          contents to XML
    */
     ...
     * to the given {@code OutputStream} object in XML format.
     *
     * @param oStream the {@code OutputStream} stream to write to
     * @throws SQLException if a data source access error occurs
     * @throws IOException if a IO exception occurs
     */
