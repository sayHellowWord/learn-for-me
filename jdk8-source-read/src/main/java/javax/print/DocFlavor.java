 ...
 * <P>
 * <LI>
 * Character stream ({@link java.io.Reader Reader})
 ...
 * <P>
 * <LI>
 * Byte stream ({@link java.io.InputStream InputStream}) --
 ...
 * <BR>&#183;&nbsp;&nbsp;
 * <CODE>("text/plain", "InputStream")</CODE>
 * <BR>&#183;&nbsp;&nbsp;
 * <CODE>("text/plain; charset=us-ascii", "InputStream")</CODE>
 * <BR>&#183;&nbsp;&nbsp;
 * <CODE>("text/plain; charset=utf-8", "InputStream")</CODE>
 * <P>
 * <LI>
...
public class DocFlavor implements Serializable, Cloneable {
     ...
     * java.io.InputStream InputStream}) as the print
    ...
    public static class INPUT_STREAM extends DocFlavor {
         ...
         * <CODE>"InputStream"</CODE> (byte stream).
         *
         * @param  mimeType   MIME media type string.
         *
         * @exception  NullPointerException
        ...
        /**
         * Doc flavor with MIME type = <CODE>"application/pdf"</CODE>, print
         * data representation class name = <CODE>"InputStream"</CODE>
         * (byte stream).
         */
     ...
     * java.io.Reader Reader}) as the print data
