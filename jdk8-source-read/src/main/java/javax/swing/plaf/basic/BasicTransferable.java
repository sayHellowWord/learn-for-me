...
class BasicTransferable implements Transferable, UIResource {
    ...
    static {
        try {
            ...
            htmlFlavors[1] = new DataFlavor("text/html;class=Reader");
            htmlFlavors[2] = new DataFlavor("text/html;charset=unicode;class=InputStream");

            plainFlavors = new DataFlavor[3];
            plainFlavors[0] = new DataFlavor("text/plain;class=java.lang.String");
            plainFlavors[1] = new DataFlavor("text/plain;class=Reader");
            plainFlavors[2] = new DataFlavor("text/plain;charset=unicode;class=InputStream");
